    ...
    public class PaymentController : Controller
    {
        ...
        public IActionResult CheckOut()
        {
            var service = new
            {
                ...
                ServerUrl = "https://woochu.azurewebsites.net/Payment/callback", //https://test.com/api/payment/callback
                ClientUrl = "https://woochu.azurewebsites.net/Payment/success"   //https://test.com/payment/success
            };
            var transaction = new
            {
                No = "test00003",
